...
export class Dropdown extends Component {
  ...
  show (event = null) {
    ...
    if (this.moveMenu) {
      ...
      heightOffset = dropUpwards
        ? window.innerHeight - menuOriginalRect.top - toggleHeight / 2
        : menuOriginalRect.top
    }
  ...
  setupListeners () {
    const keyboardNavHandler = new KeyboardNavigationHandler(
      this.container,
      (event) => {
        this.hide()
        this.toggle.focus()
