...
export class PageComments extends Component {
  ...
  closeUpdateForm () {
    ...
    this.editingComment.querySelector('[comment-content]').style.display =
      'block'
    this.editingComment.querySelector(
  ...
  editComment (commentElem) {
    ...
    commentElem.querySelector('[comment-edit-container]').style.display =
      'block'
    const textArea = commentElem.querySelector(
  ...
  updateComment (event) {
    ...
    window.$http
      ...
      .catch(window.$events.showValidationErrors)
      .then(() => {
  ...
  saveComment (event) {
    ...
    window.$http
      .post(`/comment/${this.pageId}`, reqData)
      .then((resp) => {
  ...
  updateCount () {
    ...
    this.elem.querySelector('[comments-title]').textContent =
      window.trans_plural(this.countText, count, { count })
  }
