...
function register (editor, url) {
  ...
  editor.ui.registry.addToggleButton('tasklist', {
    ...
    onSetup (api) {
      editor.on('NodeChange', (event) => {
        ...
        const inList =
          parentListEl && parentListEl.classList.contains('task-list-item')
  ...
  existingBullListButton.onSetup = function (api) {
    editor.on('NodeChange', (event) => {
      ...
      const inTaskList =
        parentList && parentList.classList.contains('task-list-item')
  ...
  editor.on('click', function (event) {
    ...
    if (
      clickedEl.nodeName === 'LI' &&
      clickedEl.classList.contains('task-list-item')
    ) {
...
function elementWithinTaskList (element) {
  ...
  return (
    listEl &&
    listEl.parentNode.nodeName === 'UL' &&
    listEl.classList.contains('task-list-item')
  )
}
