...
- **Platform REST API** - _(Most actions implemented, maturing)_
  - _A REST API covering, at minimum, control of core content models (Books, Chapters, Pages) for automation and platform extension._
- **Permission System Review** - _(In Progress)_
  - _Improvement in how permissions are applied and a review of the efficiency of the permission & roles system._
